...
import com.jhaiian.clint.browser.delegates.handleHomePageLink
...
// Incognito WebViews wrap the activity in a ContextThemeWrapper, so unwrap to reach it.
private val WebView.hostActivity: android.app.Activity?
...
class AetherNetWebViewClient(
    ...
    fun tryOpenInApp(view: WebView, uri: Uri): Boolean {
        ...
        val activity = view.hostActivity as? com.jhaiian.clint.browser.MainActivity ?: return false
