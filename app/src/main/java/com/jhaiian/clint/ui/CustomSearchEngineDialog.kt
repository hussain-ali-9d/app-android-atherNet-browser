            ...
            Row(Modifier.fillMaxWidth().padding(end = 12.dp, bottom = 8.dp), horizontalArrangement = Arrangement.End) {
                ...
                TextButton(
                    onClick = {
                        ...
                        urlError = if (!isValidCustomSearchEngineUrl(trimmedUrl)) invalidUrlMessage else null
        ...
        Column(Modifier.padding(horizontal = 16.dp, vertical = 8.dp)) {
            ...
            AetherNetOutlinedTextField(
                ...
                supportingText = {
                    Column {
                        Text(
                            urlError ?: stringResource(R.string.custom_search_engine_url_helper, CustomSearchEngineQueryPlaceholder),
                            color = if (urlError != null) colors.colorError else colors.secondaryText,
                            fontSize = 12.sp
                        )
                        Text(
                            stringResource(R.string.custom_search_engine_url_example, CustomSearchEngineQueryPlaceholder),
